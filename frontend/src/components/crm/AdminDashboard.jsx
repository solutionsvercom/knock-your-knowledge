...
import { BarChart2, Users, BookOpen, DollarSign, TicketCheck, UserCheck, Shield } from "lucide-react";
...
export default function AdminDashboard({ user }) {
  ...
  return (
    <CRMLayout user={user} navItems={NAV} accentColor="#a78bfa" roleLabel="Admin">
      {hash === "overview" && (
        <OverviewSection users={users} courses={courses} payments={payments} tickets={tickets} enrollments={enrollments} />
      )}
