    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-purple-300">50+ interns every one month</span>
        </motion.div>
        ...
        >
          Join learners growing their careers with us — 50+ interns every one month.
        </motion.p>
