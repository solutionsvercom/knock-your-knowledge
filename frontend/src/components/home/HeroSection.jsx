        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center min-h-[88vh]">
          ...
          <motion.div initial={{ opacity: 0, x: -60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9 }}>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.85 }}
              ...
              {[
                { value: "Several", label: "Active Interns", color: "#a78bfa", glow: "rgba(167,139,250,0.8)" },
                { value: "19+", label: "Internship Courses", color: "#60a5fa", glow: "rgba(96,165,250,0.8)" },
                { value: "100%", label: "Placement Assistance", color: "#34d399", glow: "rgba(52,211,153,0.8)" },
              ].map(s => (
