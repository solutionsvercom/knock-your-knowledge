...
const features = [
  {
    ...
    description: "Get guidance from instructors and clear explanations tailored to your level.",
  ...
  },
  {
    ...
    description: "Follow a custom roadmap based on your learning goals and current skill level.",
  ...
  },
  {
    ...
    description: "Practice with quizzes and challenges to reinforce your learning.",
