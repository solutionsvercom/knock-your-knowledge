    ...
    <section className="py-20 lg:py-28 bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-14">
          <div>
            <p className="text-sm font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider mb-2">Internship Courses</p>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">Master In-Demand Skills</h2>
          </div>
          <Link to={createPageUrl("Courses")}>
            <Button variant="outline" className="rounded-xl gap-2">
              View All Internship Courses <ArrowRight className="w-4 h-4" />
            </Button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {!isLoading && !isError
            ...
            >
              <div className="group block bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300 hover:-translate-y-1">
